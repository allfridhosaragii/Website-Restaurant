            ...
            <div class="col-12">
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white py-3">
                        <h4 class="mb-0 text-primary">Tambah Diskon Baru</h4>
                    </div>
                        ...
                        <form action="/admin/discounts" method="POST">
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="voucher_code" class="form-control text-uppercase @error('voucher_code') is-invalid @enderror" value="{{ old('voucher_code') }}" placeholder="Misal: PROMO2024">
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-3">
                                    ...
                                    <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                                        <option value="fixed" {{ old('type') == 'fixed' ? 'selected' : '' }}>Fixed (Nominal Rp)</option>
                                        <option value="percentage" {{ old('type') == 'percentage' ? 'selected' : '' }}>Persentase (%)</option>
                                        <option value="free_item" {{ old('type') == 'free_item' ? 'selected' : '' }}>Gratis Item (Voucher Produk)</option>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="scope" id="scopeSelect" class="form-select @error('scope') is-invalid @enderror" required>
                                        <option value="order" {{ old('scope') == 'order' ? 'selected' : '' }}>Seluruh Pesanan (Order Level)</option>
                                        <option value="item" {{ old('scope') == 'item' ? 'selected' : '' }}>Menu Tertentu (Item Level)</option>
                                    </select>
                                </div>
                                <div class="col-md-3" id="menuSelectContainer" style="display: {{ old('scope') == 'item' ? 'block' : 'none' }};">
                                ...
                                <div class="col-md-3" id="freeMenuSelectContainer" style="display: {{ old('type') == 'free_item' ? 'block' : 'none' }};">
                                    ...
                                    <select name="free_menu_id" class="form-select @error('free_menu_id') is-invalid @enderror">
                                        ...
                                        @foreach($menus as $menu)
                                            <option value="{{ $menu->id }}" {{ old('free_menu_id') == $menu->id ? 'selected' : '' }}>{{ $menu->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="time" name="happy_hour_start" class="form-control @error('happy_hour_start') is-invalid @enderror" value="{{ old('happy_hour_start') }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Happy Hour Selesai (Opsional)</label>
                                    <input type="time" name="happy_hour_end" class="form-control @error('happy_hour_end') is-invalid @enderror" value="{{ old('happy_hour_end') }}">
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-4">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        @foreach($days as $val => $label)
                                            <div class="form-check form-check-inline me-2">
                                                <input class="form-check-input" type="checkbox" name="days_of_week[]" value="{{ $val }}" id="day{{ $val }}" {{ is_array(old('days_of_week')) && in_array($val, old('days_of_week')) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" name="usage_limit" min="1" class="form-control @error('usage_limit') is-invalid @enderror" value="{{ old('usage_limit') }}" placeholder="Maks Kuota">
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label">Limit per User</label>
                                    <input type="number" name="max_usage_per_user" min="0" class="form-control @error('max_usage_per_user') is-invalid @enderror" value="{{ old('max_usage_per_user', '0') }}" placeholder="0 = No Limit">
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="text-end">
                                <button type="submit" class="btn btn-primary px-4 py-2">
                                    <i class="bi bi-save me-2"></i> Simpan Diskon
                                </button>
                            </div>
