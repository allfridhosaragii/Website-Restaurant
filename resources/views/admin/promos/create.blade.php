...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto bg-white rounded-lg shadow overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Tambah Promo Buy X Get Y</h2>
        </div>
        
        <form action="{{ route('admin.promos.store') }}" method="POST" class="p-6" x-data="{ getType: 'free' }">
            @csrf
            <input type="hidden" name="type" value="buy_x_get_y">
            
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2">Nama Promo</label>
                <input type="text" name="name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required placeholder="Contoh: Beli 2 Nasi Goreng Gratis 1 Es Teh">
            </div>
            ...
            <div class="grid grid-cols-2 gap-6 mb-6 p-4 border rounded bg-blue-50">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <input type="number" name="buy_quantity" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required value="1" min="1">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="get_quantity" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required value="1" min="1">
                    </div>
                    ...
                    <div x-show="getType == 'discount'" class="mt-2">
                        ...
                        <input type="number" name="get_discount_percent" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="50" min="1" max="99">
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="datetime-local" name="start_date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required value="{{ now()->format('Y-m-d\TH:i') }}">
                </div>
                <div>
                    <label class="block text-gray-700 text-sm font-bold mb-2">Tanggal Selesai</label>
                    <input type="datetime-local" name="end_date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required value="{{ now()->addMonth()->format('Y-m-d\TH:i') }}">
                </div>
            </div>

            <div class="mb-6">
                <label class="flex items-center">
                    <input type="checkbox" name="is_active" class="form-checkbox h-5 w-5 text-blue-600" checked value="1">
